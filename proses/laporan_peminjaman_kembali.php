            ...
            <tr>
                <?php
                    ...
                    if($nisLaporan == 0){
                        ...
                        $qPinjam = mysqli_query($koneksi, "SELECT * FROM tb_kembali k LEFT JOIN tb_buku b ON k.id_buku = b.id_buku LEFT JOIN tb_anggota a ON a.nis = k.nis WHERE k.tgl_kembali='$nisLaporan'");
                    }
                    $no = 0;
