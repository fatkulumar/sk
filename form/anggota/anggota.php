        ...
        <table id="table_anggota" class="table table-striped">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <a onclick="return confirm('Yakin Hapus Anggota?')" class="btn btn-danger btn-sm" href="../../../proses/proses.php?hapusAnggota=<?= $rAnggota["nis"] ?>">Hapus</a>  <a class="btn btn-success btn-sm" href="index.php?editAnggota=<?= $rAnggota["nis"] ?>">Edit</a>
                    </td>
                </tr>
                <?php endwhile ?>
            </tbody>
